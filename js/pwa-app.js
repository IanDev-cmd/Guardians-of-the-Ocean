...
(function () {
  ...
  var ICONS = [
    ...
    { headline:'Secure Asset Vault', subtext:'$1.25M USD total value locked across 3 multi-signature reserve vaults.', svg:'<rect x="5" y="11" width="14" height="9" rx="2" stroke-width="1.4"/><path d="M8 11V8a4 4 0 0 1 8 0v3" stroke-width="1.4"/><circle cx="12" cy="15.5" r="1.2" stroke-width="1.4"/>', view:'wallet' },
    { headline:'Campaign Roadmap', subtext:'Phase 3 of 4 active: 85% completion rate across 12 field delivery routes.', svg:'<path d="M4 18c3-6 6-2 9-8 2-4 4-4 7-4" stroke-width="1.4" stroke-linecap="round"/><circle cx="4" cy="18" r="1.2" stroke-width="1.4"/><circle cx="20" cy="6" r="1.2" stroke-width="1.4"/>', view:'roadmap' },
    ...
    { headline:'Fiat & Token Treasury', subtext:'Balance: $4,250.00 USD | 12,500 HBAR | 250 custom HTS impact tokens.', svg:'<path d="M4 9V7a2 2 0 0 1 2-2h9" stroke-width="1.4" stroke-linecap="round"/><path d="M4 8a2 2 0 0 1 2-2h11a2 2 0 0 1 2 2v9a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V8Z" stroke-width="1.4" stroke-linejoin="round"/><circle cx="16.3" cy="12.5" r="0.9" stroke-width="1.4"/>', view:'wallet' },
    { headline:'Grants & Micro-Stipends', subtext:'$142,000 distributed across 320 verified local field operators this month.', svg:'<path d="M3 12l4-4 3 2 3-2 4 4-2 2-2-1-2 2-2-1-2 1-2-2Z" stroke-width="1.3" stroke-linejoin="round"/>', view:'milestone' },
